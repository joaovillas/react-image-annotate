    ...
    >
      ...
      >
        <Workspace
          ...
          rightSidebarItems={[
            debugModeOn && (
              <DebugBox key={"debug-box"} state={debugModeOn} lastAction={state.lastAction} />
            ),
            state.taskDescription && (
              <TaskDescription key={"task-description"} description={state.taskDescription} />
            ),
            state.regionClsList && (
              <ClassSelectionMenu
